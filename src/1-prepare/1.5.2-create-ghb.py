...
cond2_IP      = xr.open_dataarray(r"data/2-interim/cond2_IP.nc")
cond3_IP      = xr.open_dataarray(r"data/2-interim/cond3_IP.nc")  
cond4_IP      = xr.open_dataarray(r"data/2-interim/cond4_IP.nc")  
cond5_IP      = xr.open_dataarray(r"data/2-interim/cond5_IP.nc")
cond6_IP      = xr.open_dataarray(r"data/2-interim/cond6_IP.nc")  
