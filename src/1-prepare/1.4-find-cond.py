# %%
"""
- Find the conductances for polder area in the 250m model, using data from riv 25m model 
...
inf_ponds_stage_re = mean_regridder.regrid(inf_ponds["stage"].mean("time"), like)
